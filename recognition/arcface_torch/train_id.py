...
from dataset import MXFaceDataset, DataLoaderX, MXCardIDDataset
...
def main(args):
    ...
    train_set = MXCardIDDataset(root_dir=cfg.rec, local_rank=local_rank, 
    imgrec_name=cfg.imgrec_name, imgidx_name=cfg.imgidx_name, mean=cfg.MEAN, std=cfg.STD)
